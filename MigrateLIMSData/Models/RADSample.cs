    ...
    public class RADSample
    {
        ...
        protected void InitSampleNode()
        {
            ...
            "<EN:SampleCollectionEndTime>" + "{9}" + "</EN:SampleCollectionEndTime>\r\n" +
             "<EN:StateClassificationCode>" + "{10}" + "</EN:StateClassificationCode>\r\n" +
            "</EN:SampleIdentification>\r\n" + "<EN:SampleLocationIdentification>\r\n" +
            "<EN:SampleLocationIdentifier>" + "{11}" + "</EN:SampleLocationIdentifier>\r\n" +
            "</EN:SampleLocationIdentification>\r\n" + "</EN:Sample>\r\n";
        }
        ...
        public string StateClassificationCode { get; set; }
        public string SampleLocationIdentifier { get; set; }
        public string XMlSampleElement { get; set; }
        public string FetchSampleXML()
        {
            return string.Format(XMlSampleElement, RecordID, LabSampleIdentifier, PWSIdentifier, PWSFacilityIdentifier, SampleRuleCode, SampleMonitoringTypeCode,  ComplianceSampleIndicator, AdditionalSampleIndicator, SampleCollectionEndDate, SampleCollectionEndTime, StateClassificationCode, SampleLocationIdentifier);
        }
    }
}
